...
create table Junk(
    ...
    Kwota_rachunku_przedzial varchar(10),
...
create table Wizyta_w_salonie(
    ...
    Czy_widziala_reklame bit,
    Kwota_Rachunku float,
    Czy_Przyszla_Z_Powodu_Reklamy bit,
    Cena_Pozyskania_Klienta float,
    Zysk float,
    Czy_Zarezerwowal_kolejna bit,
    Czy_kupil_zareklamowana_usluge bit
)